...
const PRINCIPLES = [
  ...
  { n: "04", t: "Motion must explain", d: "Animation communicates causality and continuity. If removing an animation loses no information, remove it. Nothing exceeds 400ms and everything degrades under reduced motion.", e: "transition duration-[var(--duration-fast)] ease-out-quint" },
