  ...
  return <main id="main" tabIndex={-1} className="beta-page">
    <div className="home-container">
      ...
      <section className="beta-page-faq"><h2>No surprises.</h2><Accordion variant="flush" items={[
        ...
        { key: "future", title: "Will Unseen become paid?", content: "The components are MIT licensed, so the base stays free and open source whatever happens later. A future paid tier could only ever be an addition to that base — the MIT grant already given cannot be withdrawn." },
